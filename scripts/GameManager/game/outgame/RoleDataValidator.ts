...
export class RoleDataValidator {
    private constructor(private readonly game: WerewolfGameManager) {}

    public static create(game: WerewolfGameManager): RoleDataValidator {
        return new RoleDataValidator(game);
    }
